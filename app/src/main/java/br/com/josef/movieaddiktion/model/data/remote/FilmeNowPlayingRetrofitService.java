...
import br.com.josef.movieaddiktion.BuildConfig;
...
public class FilmeNowPlayingRetrofitService {
    ...
    public static FilmeNowPlayingAPI getApiService() {
        return getRetrofit().create(FilmeNowPlayingAPI.class);
    }
}